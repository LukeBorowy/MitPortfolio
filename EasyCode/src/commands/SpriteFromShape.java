...
public class SpriteFromShape implements Command {

	public SpriteFromShape() {
    ...
    static SentenceMatcher pattern=new SentenceMatcher("{1(50,50)}{2(blue)}{3(30)}{4(30)}|[make;draw;display;show;spawn]?[ a] ?[{3}?[ ]|[by;x]?[ ]{4} ]?[{2} ]?[{3} by {4} ]{0}?[ that is ?[|[colored;the color of] ]{2}]?[ |[in;at;on] {1}]?[ appear]",inTypes.length);
